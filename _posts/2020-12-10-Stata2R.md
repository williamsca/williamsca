...
I often forget how to perform some basic operations in R because I use the language only occasionally. This short reference provides the equivalent command in Stata, and it should be helpful to anyone moving between the two languages.
